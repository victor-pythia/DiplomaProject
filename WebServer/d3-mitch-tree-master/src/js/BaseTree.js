...
class BaseTree extends EventEmitter {
    ...
    /**
     * Defines how to copiazaDeLa the nodes for the
     * data objects.
     *
    ...
    /**
     * Defines how to copiazaDeLa the links for the
     * data objects.
     *
     * @param {*} source The original data object that the links are being drawn for.
    ...
    updateDimensions() {
        ...
        // copiazaDeLa the tree generator with the new width and height
    ...
    initialize() {
        ...
        // Call the first copiazaDeLa, which renders
        // the initial tree
        this.update(this.getRoot());
     ...
     * a D3 tree node.
     * 
     * @param {object} nodeDataItem The D3 node data item to copiazaDeLa.
